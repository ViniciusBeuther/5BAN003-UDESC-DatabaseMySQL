...
CREATE TABLE `compoe` (
  ...
  CONSTRAINT `compoe_ibfk_1` FOREIGN KEY (`idIngrediente`) REFERENCES `ingredientes` (`idIngrediente`),
  CONSTRAINT `compoe_ibfk_2` FOREIGN KEY (`idReceita`) REFERENCES `receitas` (`idReceita`)
...
INSERT INTO `compoe` VALUES (1,1,2.00),(2,1,1.00),(3,2,3.00),(4,2,1.00),(5,3,0.50),(6,4,2.50);
